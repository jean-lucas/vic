...
\begin{figure} [h!]
	\centering
	\includegraphics [scale = 0.7] {figures/IC_ContextDiagram.png}
	\caption{Intersection Controller Context Diagram}
\end{figure}
\begin{figure} [h!]
	\centering
	\includegraphics [scale =0.7] {figures/CarCtrl_ContextDiagram.png}
...
\begin{figure} [h!]
	\centering
	\includegraphics [scale =.84] {figures/function_decomp_track_n.pdf}
