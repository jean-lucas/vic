...
\thispagestyle{empty}
\section{Revisions}
\begin{longtable}{| p{.2\textwidth } | p{.21\textwidth } | p{.21\textwidth } | p{.27\textwidth } |}
...
% Track Requirement
\multicolumn{1}{|c|}{\multirow{3}{*}{November 29,2016}} 
				     &\multicolumn{1}{c|}{\multirow{3}{*}{Revision 1}} 
				     &\multicolumn{1}{l|}{\multirow{3}{*}{Zachary Bazen}} 
				     & Updated monitored and controlled variables \\
                               &  &  & \cellcolor{tableCell}Updated naming \newline conventions \\ \hline 
...
\cellcolor{tableCell}\textbf{VIC} & \cellcolor{tableCell}Vehicle intersection control \\ 
...
\cellcolor{tableCell}\textbf{c\_vc\_variableName}  & \cellcolor{tableCell}Control variable for autonomous vehicle controller \\ \hline
...
\subsubsection{Intersection Controller}

\begin{longtable}{ |p{.33\textwidth }  p{.625\textwidth }|}  \hline
\textbf{m\_ic\_readSensor[8]} &   \\

\cellcolor{tableCell}\textbf{m\_ic\_carSignal[4]}  & \cellcolor{tableCell}\\  \hline
\end{longtable}

\subsubsection{Autonomous Vehicle Controller}

\begin{longtable}{ |p{.33\textwidth }  p{.625\textwidth }|}  \hline
\textbf{m\_vc\_videoCapture[x][y]} &  \\ 

\cellcolor{tableCell}\textbf{m\_vc\_frontDistance}  & \cellcolor{tableCell} \\ 


\textbf{m\_vc\_speedSignal} & \\

\cellcolor{tableCell}\textbf{m\_vc\_hallEffect}  & \cellcolor{tableCell} \\ 

\textbf{m\_vc\_vehicleOrientation} & \\\hline
\end{longtable}
...
\textbf{c\_ic\_carProceedSignal} & \\ \hline
\end{longtable}

\subsubsection{Autonomous Vehicle Controller}

\begin{longtable}{ |p{.33\textwidth }  p{.625\textwidth }|}  \hline
\textbf{c\_vc\_wheelAngle} &   \\

\cellcolor{tableCell}\textbf{c\_vc\_carSpeed}  & \cellcolor{tableCell} \\ 

\textbf{c\_vc\_vehicleBreak} & \\ 

\cellcolor{tableCell}\textbf{c\_vc\_requestTheIC}  & \cellcolor{tableCell}\\ \hline
\end{longtable}
...
\begin{figure} [h!]
	...
	\centering
	\includegraphics [scale =.7] {figures/function_decomp_IC.pdf}
