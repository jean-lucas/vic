...
\hspace{-2.1cm}{
 ...
 \hspace{2.0cm} {\textbf{4.1.1.2 Component 2 Verification}} \vspace{2mm}
 \begin{longtable}{ |p{0.14\textwidth }  | p{0.20\textwidth } |  p{0.22\textwidth } |  p{0.23\textwidth } | p{0.18\textwidth } | p{0.23\textwidth } |  p{0.24\textwidth }|}  \hline
    ...
    % ---------------- Block 1------------------- %
    % Row 1
    \cellcolor{subsectionC}\centering \textbf{Design Component} 
    & \multicolumn{1}{c|}{\cellcolor{tableCell}\textbf{Failure Modes} }
    & \multicolumn{1}{c|}{\textbf{Causes of Failure}}
    & \multicolumn{1}{c|}{\cellcolor{tableCell}\textbf{Effects of Failure}}
    & \multicolumn{1}{c|}{\textbf{Detection}} 
    & \multicolumn{1}{c|}{\cellcolor{tableCell} \textbf{Controls} }
