...
\begin{center}
    \textbf{\hl{"i. Module [number] name, services (responsibilities) and secrets\\
ii. Views of the module decomposition (maybe a table showing a Uses Relationship
- hopefully a Uses hierarchy)"}}
\end{center}


\begin{center}
    \textbf{\hl{Possibly move the module guide from draft system design}}
\end{center}
...
\begin{center}
    \textbf{Insert MIS (Possibly move from draft system design)}
\end{center}

\begin{center}
    \textbf{Insert MID (Table)} \\
    
    \textbf{Insert Hardware Design}\\
...
\begin{center}
    \textbf{\hl{"i. Derived timing constraints (from requirements)\\
ii. Scheduling of "set" programs"}}
\end{center}
